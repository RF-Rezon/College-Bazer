...
const AdmissionForm = () => {
    ...
    const {
     ...
     fetch("https://college-bazar-server.vercel.app/form_to_datababe", {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        console.log("form goes to database successfully");
      })
    }
...
<section className="relative flex flex-wrap lg:h-screen lg:items-center">
  <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
    <div className="mx-auto max-w-lg text-center">
      <h1 className="text-2xl font-bold sm:text-3xl">Admission Form</h1>

      <p className="mt-4 text-gray-500">
        Fill up carefully.   
      </p>
      <p className="mt-4 text-red-500">
        You must put the same email you used for registration.
      </p>
    </div>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
      ...
      <input type="submit"
          className="inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white" value="Submit"/>
    </form>
  </div>
