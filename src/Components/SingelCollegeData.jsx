...
const SingleCollege = ({ eachCollegeData }) => {
  const { _id, college_image, college_name, admission_date, events_details, research_papers, college_sports } =
    eachCollegeData;
  return (
    <div>
      <div className=" rounded-lg bg-gray-600 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            {research_papers.map((single, index) => (
              <div>
